  ...
  <!-- ################################################################################################ -->
      ...
      <?php
        ...
        if ($result=mysqli_query($link, $SQL)){
            ...
            echo "<td class='tdBlack'><b>募款計畫</b></td>";
            echo "<td class='tdBlack'><b>計畫內容</b></td>";
            echo "<td class='tdBlack'><b>機構</b></td>";
            echo "<td class='tdBlack'><b>標籤</b></td>";
            echo "<td class='tdBlack' style='width:150px;'><b>連結</b></td>";
            echo "<td class='tdBlack'></td>";
            echo "<td class='tdBlack'></td>";
            $i = 1;
            while($row=mysqli_fetch_assoc($result)){
                ...
                echo "<td class='tdBlack' style='width:70px;'><a href='deletePlan.php?pNo=".$row["pNo"]."'' style='color: #345998;'><u>刪除</u></a></td>";
                echo "<td class='tdBlack'><a href='updatePlan.php?pNo=".$row["pNo"]."'' style='color: #345998;'><u>編輯</u></a></td>";                
                echo "</tr>";
            }
            ...
            echo "<tr>
                ...
                <td></td>
                <td class='tdBlack' style='width:70px;'><button type='submit' style='color: #345998; border:0;background-color: rgba(0, 0, 0, 0);cursor:pointer;'><u>新增</u></button></td></tr>";
            echo "</table>";
            echo "</form>";
        }
    ?>
