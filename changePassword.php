...
<div  style="background:linear-gradient(180deg, #FFFFFF 0%, #FFFFFF 21.8%,#bbf0aa 21.8%,  #bbf0aa 100%);"> 
  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
     ...
     <div class ="fl_right">
        <br/>
        <h1 class="heading"><font color="black" size="7">修改密碼</font></h1>   
    </div>
      <!-- ################################################################################################ -->
    </header>
  </div>
  ...
  <form action = "changePasswordConfirm.php" method = "post" style = "width: 100%;" enctype = "multipart/form-data">
    <input type="password" name="uPwd" style="font-size:25px;color:#000;" placeholder="密碼" required>
    <br/>
