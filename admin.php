    ...
    <div class="wrapper row2">
        <div class="hoc">
            <div class="inspace-80">
                <center>
                    <button type = "button" class="square1" name="button1"><a href="accountManagement.php" style="color: #FFF;">帳號管理</a></button>       
                    <button type = "button" class="square2" name="button2"><a href="subscribeManagement.php" style="color: #000;">訂閱管理</a></button> <br/>
                    <button type = "button" class="square3" name="button3" style="border-bottom-left-radius: 50px;"><a href="NPOManagement.php" style="color: #000;">機構管理</a></button> 
                    <button type = "button" class="square4" name="button4" style="border-bottom-right-radius: 50px;"><a href="informationManagement.php" style="color: #FFF;">最新消息</a></button> 
                </center>
            </div>
            </div>      
        </div>
