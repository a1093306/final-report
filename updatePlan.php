...
<div  style="background:linear-gradient(180deg, #FFFFFF 0%, #FFFFFF 130px,#bbf0aa 130px,  #bbf0aa 100%);"> 
  ...
  <!-- ################################################################################################ -->
      ...
      <?php
        ...
        if ($result=mysqli_query($link, $SQL)){
            ...
            while($row=mysqli_fetch_assoc($result)){
                ...
                <td class='tdBlack'style='color: #345998;'><button type='submit'><u>確定</u></button></td>
                </tr>";
            } 
            echo "</table>";
            echo "</form>";
    ...
    <h1 style='color:#000; font-size:27px;'>刪除標籤</h1>
    <?php
        ...
        echo "<br/><br/>";
        echo "<button type='submit' class='button1'>刪除</button>";
        echo "</form>";
    ?>
    <br/><br/>
    <h1 style='color:#000; font-size:27px;'>新增標籤</h1>
    <form action='addTag.php' method = 'post' style = 'width: 100%;' enctype = 'multipart/form-data'>
        ...
        <input type='text' name='newTag' style='display:inline;font-size:22px;width:260px;color:#000;' placeholder='多個標籤請用"#"隔開' required>
