...
<div  style="background:linear-gradient(180deg, #FFFFFF 0%, #FFFFFF 22%,#bbf0aa 22%,  #bbf0aa 100%);"> 
  <!-- ################################################################################################ -->
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
     ...
     <div class ="fl_right">
        <br/>
        <h1 class="heading"><font color="black" size="7">會員申請</font></h1>   
    </div>
      <!-- ################################################################################################ -->
    </header>
  </div>
  ...
  <form action = "enrollConfirm.php" method = "post" style = "width: 100%;" enctype = "multipart/form-data">
    <input type="email" name="email" style="font-size:25px;color:black;" placeholder="請輸入您的電子郵件信箱" required>
    <br/>
    <input type="password" name="uPwd" style="font-size:25px;color:black;" placeholder="請輸入您的密碼" required>
    <br/>
    <input  type="password" name="uPwd1" style="font-size:25px;color:black;" placeholder="請再次輸入密碼" required>
    </br></br>
    <button class="hoc clear" type="submit" style="width:120px;height:40px;background-color:#70ad47"><font color="white">註冊</font></button>
  </form>
    <br/><br/><br/>
      <!-- ################################################################################################ -->
